...
const Muah = ({ posts, locale }) => {
    ...
    const muahName = posts[0].fields.muah.fields.name;
    ...
    return (
        <>
            <Head>
                <title>{intl.formatMessage({ id: 'muah.seoTitle' }, { muah: muahName })}</title>
                <meta name="description" content={intl.formatMessage({ id: 'muah.seoDescription' }, { muah: muahName })}/>
                <meta property="og:title" content={intl.formatMessage({ id: 'muah.seoTitle' }, { muah: muahName })}/>
                <meta property="og:description" content={intl.formatMessage({ id: 'muah.seoDescription' }, { muah: muahName })}/>
            </Head>
            <Layout hero
                dark
                pageNsfw={pageNsfw}
